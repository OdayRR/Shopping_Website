            ...
            <div class="container-fluid">
                ...
                <div>
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?PHP } ?>    
                        <li><?php if (isset($_SESSION['name'])) { ?><li><a href="logout.php"><span class="glyphicon glyphicon-log-in" style="padding-top: 10px"></span> Logout</a></li> <?PHP
                        } else {
                            ?> <li><a href="login.php"><span class="glyphicon glyphicon-log-in" style="padding-top: 10px"></span> Login</a></li><?php
                            ?> <li><a href="signUp.php"><span class="glyphicon glyphicon-user" style="padding-top: 10px"></span> sign Up</a></li><?php
                        }
                        ?>
